...
<script>
    $(function () {
        ...
        $("#updateCourseInputForm").form('load','${pageContext.request.contextPath}/user/findOne?id=${param.id}'); //{"id":"21","name":"小黑"}
...
<div style="text-align: center;">
    <form id="updateCourseInputForm" class="easyui-form" method="post" enctype="multipart/form-data">
        ...
        <div style="margin-top: 20px;">
        成绩: <input type="text" name="marking1"  class="easyui-textbox">
    </div>
        <div style="margin-top: 20px;">
          <input type="hidden" name="marking2" value="${param.marking2}">
